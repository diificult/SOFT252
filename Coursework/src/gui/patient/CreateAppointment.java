...
public class CreateAppointment extends JFrame {
	...
	public CreateAppointment() {
		...
		//		SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
			//	String date = spDay.getValue() + "/" + spMonth.getValue() + "/" + spYear.getValue();
			//	String date = formatter.format(unformatedDate);
				Date date = new Date((int)spYear.getValue() - 1900,(int) spMonth.getValue() - 1,(int) spDay.getValue(),(int) spHour.getValue(),(int) spMinute.getValue(), 0);
